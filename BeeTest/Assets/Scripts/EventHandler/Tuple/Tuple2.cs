...
namespace Eppy
{
    ...
    public sealed class Tuple<T1, T2>
    {
		...
		/// </summary>
		/// <param name="tuple">A tuple that takes elements of the same types</param>
        ...
        public static bool operator==(Tuple<T1, T2> a, Tuple<T1, T2> b)
        {
			...
			if ( ((object)a) == null || ((object)b) == null )
				return false;
			if (( a.item1 == null && b.item1 != null ) || ( a.item1 != null && b.item1 == null )) 
				return false;
            if (( a.item2 == null && b.item2 != null ) || ( a.item2 != null && b.item2 == null )) 
				return false;

			items1Equal = ( a.item1 == null && b.item1 == null ) ? true : a.item1.Equals(b.item1);
			items2Equal = ( a.item2 == null && b.item2 == null ) ? true : a.item2.Equals(b.item2);
            return items1Equal && items2Equal;
        }
